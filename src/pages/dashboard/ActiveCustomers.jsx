...
const ActiveCustomers = () => {
  ...
  const fetchActiveCustomers = async (page = 1, perPage = 10) => {
    try {
      setIsLoading(true);
      setError(null);
      ...
      setError(error.message || 'Failed to fetch active customers');
      toast.error('Failed to load active customers. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  useEffect(() => {
    fetchActiveCustomers(currentPage, itemsPerPage);
  }, [currentPage]);
  ...
  const transformedCustomers = useMemo(() => {
    return customers.map(customer => ({
      ...
      joinDate: customer.appraisal_date,
          ...
          {isLoading || isSorting ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              <div className="text-center">
                ...
                <button
                  onClick={() => fetchActiveCustomers(currentPage, itemsPerPage)}
