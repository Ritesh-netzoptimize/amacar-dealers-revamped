...
const SalesManagerContainer = ({
  ...
  // Check screen size for custom breakpoint
  useEffect(() => {
  ...
  const handleEditSalesManager = useCallback(
    (salesManagerId) => {
  ...
  const handleModalSuccess = useCallback(
    (salesManagerId, isActivated) => {
      // Call refresh callback to update the data
      onRefresh();
      console.log(
        `Sales manager ${salesManagerId} ${
    ...
    const baseColumns = [
      ...
      columnHelper.accessor("dates", {
        ...
        cell: ({ getValue }) => {
          ...
          if (!lastLogin)
            return <div className="text-sm text-neutral-500">Never</div>;
            ...
            <DropdownMenu>
              ...
              >
                ...
                {row.original.status === "Inactive" ? (
                  <DropdownMenuItem
                    onClick={() =>
                      handleActivateDeactivate(row.original.id, "activate")
                    }
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      handleActivateDeactivate(row.original.id, "deactivate")
                    }
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      ...
                      side="bottom"
                      sideOffset={8}
                      className="w-52 p-1 shadow-lg border border-neutral-200 bg-white rounded-lg z-50"
                    >
                      {/* <DropdownMenuItem
                      onClick={() => onViewSalesManager(row.original.id)}
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-neutral-600">Last Login</span>
