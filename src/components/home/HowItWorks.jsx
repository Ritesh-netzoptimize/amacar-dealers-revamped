  ...
  const steps = [
    {
      ...
      gradient: "from-[#4A90E2] to-[#4A90E2]",
    },
    {
      number: "2",
      ...
      gradient: "from-[#FF8C42] to-[#FF8C42]",
    },
    {
      number: "3",
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-24 left-0 right-0 h-0.5 bg-gradient-to-r from-[#4A90E2] via-[#FF8C42] to-[#3DD598] opacity-20" />
          ...
          {steps.map((step, index) => (
            <AnimatedSection key={index}>
              ...
              >
                ...
                {/* Card */}
                <div className="relative p-8 pt-12 bg-white rounded-2xl border border-[#E5E5E5] shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:border-[#4A90E2]/20">
                  {/* Icon */}
                  <div
                  ...
                  <h3 className="text-2xl font-bold text-[#1A1A1A] mb-4 group-hover:text-[#4A90E2] transition-colors duration-300">
                    {step.title}
                  </h3>
        ...
        >
          <div className="inline-flex items-center space-x-2 px-6 py-3 bg-[#4A90E2] text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group">
