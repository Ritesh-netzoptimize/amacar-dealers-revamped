...
export default function HowItWorks () {
    ...
    const steps = [
      {
        ...
        description: "Complete your dealer verification and get instant access to our live auction platform. No lengthy approval processes.",
      ...
      },
      {
        ...
        description: "Review pre-qualified private seller vehicles that match your inventory needs. Get detailed vehicle reports and photos.",
      ...
      },
      {
        ...
        description: "Participate in real-time auctions with unlimited bidding. Win quality vehicles at competitive prices with zero per-unit fees.",
    ...
    return (
      <section id="how-it-works" className="py-18 bg-gradient-to-br from-white to-[#F8F9FA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-20">
            <div className="inline-block px-4 py-2 bg-[#FF8A3D]/10 rounded-full mb-6">
              <span className="text-[#FF8A3D] font-semibold text-sm">Simple Process</span>
            </div>
            ...
            <p className="text-xl text-[#2C3E50]/70 max-w-3xl mx-auto leading-relaxed">
              Get started in minutes with our streamlined 3-step process designed for maximum efficiency
            </p>
          </AnimatedSection>
              ...
              <AnimatedSection key={index}>
                ...
                >
                  ...
                  <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 z-10">
                    <div className={`w-16 h-16 bg-gradient-to-r ${step.gradient} rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-2xl group-hover:scale-110 transition-transform duration-300`}>
                      {step.number}
                    </div>
                  </div>
                  ...
                  <div className="relative p-8 pt-12 bg-white rounded-2xl border border-[#E9ECEF] shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:border-[#2B5A8E]/20">
                    {/* Icon */}
                    <div className={`w-16 h-16 bg-gradient-to-r ${step.gradient} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                      {step.icon}
                    </div>
                    ...
                    {/* Hover indicator */}
                    <div className={`absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r ${step.gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500`} />
                  </div>
                </motion.div>
              </AnimatedSection>
            ))}
