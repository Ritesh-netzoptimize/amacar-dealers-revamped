              ...
              <AnimatedSection key={index}>
                ...
                >
                  <button
                    ...
                    className="cursor-pointer w-full p-8 text-left flex justify-between items-center hover:bg-gradient-to-r hover:from-[#4F46E5]/5 hover:to-[#15A9D8]/5 transition-all duration-300 group"
                  >
                    <div className="flex items-center space-x-4">
                      <div className="w-10 h-10 bg-gradient-to-r from-[#4F46E5] to-[#4F46E5] rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                        <HelpCircle className="w-5 h-5" />
                      </div>
                      <span className="font-bold text-[#1A1A1A] text-lg group-hover:text-[#4F46E5] transition-colors duration-300">
                        {faq.question}
                      </span>
                    </div>
                    <motion.div
                      ...
                      className="w-10 h-10  rounded-xl flex items-center justify-center text-[#4F46E4] shadow-lg group-hover:scale-110 transition-transform duration-300"
                    >
                      {openIndex === index ? (
