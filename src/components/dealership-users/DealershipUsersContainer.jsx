...
const DealershipUsersContainer = ({
  ...
  // Handle custom breakpoint at 1500px
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Mobile Card Layout - Below 1500px */}
        {!isDesktop && (
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="text-sm text-neutral-600 flex items-center gap-2 min-w-0">
                    ...
                    <div className="text-sm text-neutral-600 flex items-center gap-2 min-w-0 sm:col-span-2">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="outline"
                          size="sm"
                          className="flex-1 sm:flex-none h-10 text-sm hover:bg-neutral-100"
                        >
