...
const FilterTabs = ({ activeFilter, onFilterChange, className = '', isLoading = false }) => {
  const [isTransitioning, setIsTransitioning] = useState(false);
  const [loadingTabId, setLoadingTabId] = useState(null);

  const filters = [
    { id: 'allTime', label: 'All Time', count: null },
    { id: 'today', label: 'Today', count: null },
    { id: 'thisWeek', label: 'This Week', count: null },
    { id: 'thisMonth', label: 'This Month', count: null },
    { id: 'passed', label: 'Passed Vehicles', count: null }
  ];
